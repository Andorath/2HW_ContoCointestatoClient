...
public class ObjectFactory {
    ...
    private final static QName _GetReadResults_QNAME = new QName("http://webservice.conto/", "getReadResults");
    private final static QName _GetReadResultsResponse_QNAME = new QName("http://webservice.conto/", "getReadResultsResponse");
    ...
    private final static QName _ReadResponse_QNAME = new QName("http://webservice.conto/", "readResponse");
    ...
    /**
     * Create an instance of {@link GetReadResultsResponse }
     * 
     */
    public GetReadResultsResponse createGetReadResultsResponse() {
        return new GetReadResultsResponse();
    }

    /**
     * Create an instance of {@link GetReadResults }
     * 
     */
    public GetReadResults createGetReadResults() {
        return new GetReadResults();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link GetReadResults }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.conto/", name = "getReadResults")
    public JAXBElement<GetReadResults> createGetReadResults(GetReadResults value) {
        return new JAXBElement<GetReadResults>(_GetReadResults_QNAME, GetReadResults.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link GetReadResultsResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.conto/", name = "getReadResultsResponse")
    public JAXBElement<GetReadResultsResponse> createGetReadResultsResponse(GetReadResultsResponse value) {
        return new JAXBElement<GetReadResultsResponse>(_GetReadResultsResponse_QNAME, GetReadResultsResponse.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.conto/", name = "readResponse")

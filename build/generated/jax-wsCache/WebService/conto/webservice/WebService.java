 ...
 * 
 */
@WebServiceClient(name = "WebService", targetNamespace = "http://webservice.conto/", wsdlLocation = "http://localhost:8080/ContoCointestato-war/WebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICE_QNAME = new QName("http://webservice.conto/", "WebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/ContoCointestato-war/WebService?wsdl");
    ...
    public WebServices getWebServicesPort() {
        return super.getPort(new QName("http://webservice.conto/", "WebServicesPort"), WebServices.class);
    }
    ...
    public WebServices getWebServicesPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.conto/", "WebServicesPort"), WebServices.class, features);
    }
